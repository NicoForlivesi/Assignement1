...
public class Ball {
    ...
    // Metodi non synchronized per questa versine
    public BallType getLastHitBy() { return lastHitBy; }
    public P2d getPos() { return pos; }
    public V2d getVel() { return vel; }
    public boolean stillAlive() { return stillAlive; }

    public void setLastHitBy(BallType hitter) { this.lastHitBy = hitter; }
    public void setStillAlive(boolean stillAlive) { this.stillAlive = stillAlive; }

    public void updatePosition (double dt, double frictionFactor, int width, int height) {
    ...
    public void kick(V2d newVel) {
        this.vel = newVel;
    }

    // Aggiornamento dello stato durante una collisione
    public void updateVelocityAndPosition(P2d newPos, V2d newVel) {
        this.pos = newPos;
        this.vel = newVel;
    }
}